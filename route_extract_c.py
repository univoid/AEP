...
# load Omage Graph
N_o = load_graph("OmageGraph_c.xml.gz")
...
# draw graph
graph_draw(N, pos=pos, vertex_size=size, vertex_fill_color=color, edge_pen_width=prop_to_size(flow, mi=0, ma=4, power=1), output="route_c.pdf")
